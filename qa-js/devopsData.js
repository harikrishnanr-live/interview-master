let devopsData = [
    {
        ...
        "answer": "DevOps is a set of practices that combines software development (Dev) and IT operations (Ops) to shorten the development lifecycle and provide continuous delivery of high-quality software."
    },
    {
        "id": 2,
        "question": "What is CI/CD?",
        "answer": "CI/CD stands for Continuous Integration/Continuous Delivery. CI is the practice of merging code changes frequently, while CD automates the delivery of applications to selected infrastructure environments."
    },
    {
        "id": 3,
    ...
    },
    {
        ...
        "answer": "Containers are lightweight, standalone, executable packages that include everything needed to run a piece of software, including the code, runtime, system tools, and libraries."
    },
    {
        "id": 5,
    ...
    },
    {
        ...
        "answer": "Faster delivery, improved collaboration, increased reliability, better scalability, and more efficient resource utilization."
    },
    {
        "id": 9,
        "question": "What is monitoring in DevOps?",
        "answer": "Monitoring involves tracking the performance and health of applications and infrastructure to identify issues and ensure optimal operation."
    },
    {
        "id": 10,
        "question": "What is Jenkins?",
        "answer": "Jenkins is an open-source automation server that enables developers to build, test, and deploy their software reliably."
    },
    {
        "id": 11,
    ...
    },
    {
        ...
        "answer": "Microservices is an architectural style that structures an application as a collection of small, independent services that communicate over well-defined APIs."
    },
    {
        "id": 14,
