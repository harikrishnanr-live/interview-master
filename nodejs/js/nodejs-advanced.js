...
let advanced = [
  ...
  },
  {
    ...
    answer:
      "A process is a whole program running on your computer with its own memory and resources. A thread is a smaller unit within a process that does a specific task. A process can have multiple threads running simultaneously.",
  },
  {
    id: 9,
    question: "What is rate limiting?",
    answer:
      "Rate limiting is a technique used to control the amount of requests a user or client can make to a server within a specified time period. It is used to prevent abuse, ensure fair resource distribution, and protect against DDoS attacks.",
  },
  {
    id: 10,
    question: "What is API caching (Redis)?",
    answer:
      "API caching with Redis involves storing frequently requested API responses in Redis, an in-memory key-value store. This reduces the need to fetch data from the database every time, improving performance and reducing load.",
  },
  {
    id: 11,
    question: "What is JWT Authentication & Authorization?",
    answer:
      "JWT (JSON Web Token) is used for authentication and authorization in a stateless manner. It involves generating a signed token that contains user information, which can be sent with each request. The server verifies the token to authenticate and authorize the user.",
  },
];
