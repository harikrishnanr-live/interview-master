...
let beginner = [
  ...
  },
  {
    ...
    answer:
      "Clustering in Node.js is a way to use multiple CPU cores to run an application for better performance and handle more requests.",
  },
  {
    id: 5,
  ...
  },
  {
    ...
    answer:
      "Middleware functions execute between the request and response cycle, performing tasks like logging, authentication, and data processing. The different types of middleware are: Application-level Middleware, Router-level Middleware, Error-handling Middleware, Third-party Middleware, and Built-in Middleware.",
  },
  {
    id: 8,
    question:
  ...
  },
  {
    ...
    answer:
      "A thread pool in Node.js is like having a group of helpers (threads) ready to execute tasks that take some time, such as reading a file or making a network request. These helpers ensure that your main program keeps running smoothly without waiting for those tasks to finish.",
  },
  {
    id: 10,
