...
let intermediate = [
  {
    ...
    answer:
      "Event propagation where the event starts from the target element and bubbles up to ancestor elements.",
  },
  {
    id: 2,
    question: "What is event capturing?",
    answer:
      "Event propagation phase where the event starts from the root and goes down to the target element.",
  },
  {
    id: 3,
    question: "How do you stop event propagation?",
    answer:
      "By calling event.stopPropagation() or event.stopImmediatePropagation().",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    answer:
      "A function with access to its own scope, outer function's scope, and the global scope.",
  },
  {
    id: 9,
    question: "What is the difference between local and global scope?",
    answer:
      "Local scope is inside functions or blocks; global scope is accessible everywhere.",
  },
  {
    id: 10,
    question: "What is lexical scoping?",
    answer:
      "Variables are resolved by their physical location in the code at the time of definition.",
  },
  {
    id: 11,
  ...
  },
  {
    ...
    answer:
      "call() and apply() invoke functions with a given this; apply() takes args as array, call() as list; bind() returns a new function with bound this.",
  },
  {
    id: 15,
  ...
  },
  {
    ...
    answer:
      "NaN is a number representing 'Not a Number'; undefined means a variable is declared but not assigned.",
  },
  {
    id: 17,
    question: "What is the difference between null and undefined?",
    answer:
      "null is an intentional absence of value; undefined means variable declared but not assigned.",
  },
  {
    id: 18,
    question: "How can you convert a string to a number?",
    answer:
      "Using Number(), parseInt(), parseFloat(), or unary plus (+) operator.",
  },
  {
    id: 19,
    question: "What is event delegation?",
    answer:
      "Attaching a single event listener to a parent element to manage events on child elements.",
  },
  {
    id: 20,
    question: "What is a template literal?",
    answer:
      "String literals allowing embedded expressions using backticks and ${}.",
  },
  {
    id: 21,
  ...
  },
  {
    ...
    answer:
      "Using the class keyword: class MyClass { constructor() { } method() { } }",
  },
  {
    id: 26,
  ...
  },
  {
    ...
    answer:
      "A class can extend another class to inherit properties and methods.",
  },
  {
    id: 28,
    question: "What is a module in JavaScript?",
    answer:
      "Reusable pieces of code that can be exported and imported using import/export syntax.",
  },
  {
    id: 29,
    question:
    ...
    answer:
      "Synchronous code runs sequentially; asynchronous code runs without blocking the main thread.",
  },
  {
    id: 30,
  ...
  },
  {
    ...
    answer:
      "Enables strict mode which helps catch errors and disables some unsafe features.",
  },
  {
    id: 32,
    question:
  ...
  },
  {
    ...
    answer:
      "null is an assigned absence, undefined means uninitialized, empty string is a string with no characters.",
  },
];
