...
let beginner = [
  {
    ...
    answer:
      "NoSQL (Not Only SQL) is a database design approach that provides flexible schemas for storing and retrieving data beyond traditional relational databases.",
  },
  {
    id: 2,
    question: "What are the main types of NoSQL databases?",
    answer:
      "Document stores (MongoDB), Key-value stores (Redis), Column-family stores (Cassandra), and Graph databases (Neo4j).",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    answer:
      "Documents are the basic unit of data in MongoDB, similar to rows in relational databases but with a flexible schema.",
  },
  {
    id: 5,
